...
namespace mjf
{
	...
	{
		_array[0] = _origin.x;            _array[1]  = _origin.y;             _array[2] = 0.0f;
		//                              //                                  //
		_array[3] = _origin.x;            _array[4]  = _origin.y - _height;   _array[5] = 0.0f;
		//                              //                                  //
		_array[6] = _origin.x + _width;   _array[7]  = _origin.y;             _array[8] = 0.0f;
		//                              //                                  //
		_array[9] = _origin.x + _width;   _array[10] = _origin.y - _height;   _array[11] = 0.0f;
	}
